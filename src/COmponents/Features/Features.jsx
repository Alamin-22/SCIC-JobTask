            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="xl:w-1/3 md:w-1/2 p-4 transform transition-transform hover:scale-105 cursor-pointer">
                            <div className="border bg-red-100 border-gray-200 p-6 rounded-lg">
